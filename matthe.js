...
client.on("ready", () => {
    console.log(chalk.redBright(`Bénz Bot Aktif!`))
})
...
client.on("userUpdate", async function(oldUser, newUser) { 
    ...
    const etikettag = (ayarlar.etikettag)
    ...
    const embed = new Discord.MessageEmbed().setAuthor(member.displayName, member.user.avatarURL({ dynamic: true })).setColor('RANDOM').setTimestamp().setFooter('Bénz was here!');
